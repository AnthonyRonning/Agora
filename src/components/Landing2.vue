  ...
  <div v-cloak>
      ...
      <div class="container menu__wrapper">
        <div class="row">
          <div class="menu__logo menu__item">
            ...
            <p class="menu__logo-title">Agora</p>
          </div>
          ...
          <div class="menu__item">
            <nav class="menu__right-nav d-l-none">
              <ul>
                <li class="site-btn site-btn--accent" v-on:click.prevent="signIn">Sign in with Blockstack</li>
              </ul>
            </nav>
        ...
        <div class="row header-home__webapp-img-wrap">
          ...
          <div class="col-12">
            ...
            <p class="header-home__description header-home__description--webapp">Meet Agora. A decentralized marketplace
              ...
              Freedom to buy, freedom to sell, and no middleman to get in the way.</p>
    ...
    <section class="section">
      <div class="container">
        <div class="row">
          <div class="col-12">
            <h3 class="section__title">Pefect app for purchasers and sellers alike.</h3>
            <p class="section__description">Agora's focus is to empower and bring together all parties in a peer to peer marketplace.
            For sellers, no more worrying about your marketplace being taken down or unfair chargebacks.
            For purchasers, no more worrying about surveillance over what you buy. </p>
          </div>
        </div>
            ...
            <div class="slider slider-img slider-img--big" id="feature-slider">
              <div class="carousel__slide">
                <div class="carousel__slide-content">
                  <h4 class="carousel__slide-title">Absolutely Free</h4>
                  <p class="carousel__slide-description">Free to list items and free to shop! Agora is an open source
              ...
              <div class="carousel__slide">
                <div class="carousel__slide-content">
                  <h4 class="carousel__slide-title">Quickly Buy and Sell</h4>
              ...
              <div class="carousel__slide">
                <div class="carousel__slide-content">
                  <h4 class="carousel__slide-title">Privacy Focused</h4>
                  <p class="carousel__slide-description">All information and data generated by the users on this app
    ...
    <div class="footer">
      <div class="container">
        <div class="row">
          <div class="col-12">
            <p>© 2019 Agora – Featured as App Presentation HTML Template | Made by
...
<style scoped>
  ...
  *, ::after, ::before { box-sizing: inherit; }
  ...
  .cls-1{fill:#fff;}.cls-1,.cls-2,.cls-4,.cls-5{fill-rule:evenodd;}.cls-2{fill:#15b7b9;}.cls-3{mask:url(#mask);}.cls-4,.cls-5{fill:#f5f5f5;}.cls-4{fill-opacity:0.2;}.cls-5{fill-opacity:0.5;}
</style>
